...
TPB_fast=8 # 512//TPBY   # cuda_x (fast) not our x
...
def cu_u_driver_global(h, n, u, v, f, dx, dy, out_u):
    ...
    j,i  = cuda.grid(2)  # cuda.x cuda.y skow,fast
...
cuda_u_driver_shared.BLOCKDIM  = (threadsperblock[0]-2,threadsperblock[1]-2)
...
cuda_u_driver_shared_inner.BLOCKDIM  = (threadsperblock[0]-2,threadsperblock[1]-2)
...
#     print("threads per block",threadsperblock)
    ...
    try:
        for kk,cu_u_driver in enumerate((cuda_u_driver_shared_inner,cu_u_driver_global,cuda_u_driver_shared,)): #cu_u_driver_shared,cu_u_driver_shared_inner)):
            ...
            etpb_fast,etpb_slow = cu_u_driver.BLOCKDIM  # (fast,slow)
