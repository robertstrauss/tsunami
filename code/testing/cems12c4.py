...
def compileit (fn,blockdim=threadsperblock,border=(0,0)):
    name = fn.__name__
    fc = compiler(fn)
...
cuda_u_driver_shared= compileit(cuda_u_driver_shared_py,border=(2,2)) 
cuda_u_driver_shared_inner  = compileit(cuda_u_driver_shared_inner_py,border=(2,2))
...
cu_u_driver_global_inner_col = compileit(cu_u_driver_global_inner_col_py,blockdim=(1024,1))
...
#     print("threads per block",threadsperblock)
    ...
    res1=None
    try:
        for kk,cu_u_driver in enumerate((cu_u_driver_global_inner,cu_u_driver_global_funcs,cuda_u_driver_shared_inner,cu_u_driver_global,cu_u_driver_global_inner,cuda_u_driver_shared,)): #cu_u_driver_shared,cu_u_driver_shared_inner)):
        ...
        #testit((1,1),(1,512),cu_u_driver_global_inner_col,res1)
